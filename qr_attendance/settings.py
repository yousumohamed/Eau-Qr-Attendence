...
STATICFILES_STORAGE = 'qr_attendance.storage.CustomWhiteNoiseStorage'
...
# Session settings
SESSION_EXPIRY_HOURS = config('SESSION_EXPIRY_HOURS', default=2, cast=int)
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "QR Attendance",
    "site_brand": "QR Attendance",
"site_logo": "assets/assets/favicon.jpg",
"site_logo_classes": "img-circle",
"login_logo": None,
    "site_icon": "assets/assets/favicon.jpg",
    "welcome_sign": "Welcome to the Admin Panel",
    "copyright": "QR Attendance System",
    "search_model": "auth.User",
    "user_avatar": "admin_avatar",
    "topmenu_links": [
        {"name": "Home", "url": "dashboard", "permissions": ["auth.view_user"], "new_window": True},
        {"app": "attendance"},
    ],
    "show_sidebar": True,
    ...
    "icons": {
        ...
        "attendance.Teacher": "fas fa-chalkboard-teacher",
        "attendance.Classroom": "fas fa-chalkboard",
        "attendance.Session": "fas fa-clock",
